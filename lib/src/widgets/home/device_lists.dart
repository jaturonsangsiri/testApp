          ...
          return GestureDetector(
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                title: Text(devices[i]['name'], style: TextStyle(fontSize: Responsive.isTablet? 18 : 14, fontWeight: FontWeight.w700),),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('ID: ${devices[i]['id']}', style: TextStyle(fontSize: Responsive.isTablet? 18 : 14),),
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        DeviceStatus(bgColor: deviceDetail.getStatusColor(devices[i]['status']), textColor: Colors.white, status: devices[i]['status'], fontSize: Responsive.isTablet? 15 : 12)                                     
                      ],  
                    ),
                  ],
                ),

            ...
            builder: (context, state) {
              return Column(
                ...
                children: [
                  ...
                  CustomSwitch(
                    value: state.themeApp, 
                    onChanged: (value) => context.read<ThemeBloc>().add(SetTheme()),
                  ...
                  systemwidgetcustom.normalTextFormField(hintText: 'ชื่อผู้ใช้', controller: nameController, keyboardType: TextInputType.text, valueSave: username, focus: nameFocusNode, hintColor: state.themeApp? Colors.white70 : Colors.black),
                  ...
                  systemwidgetcustom.normalTextFormField(hintText: 'รหัสผ่านเก่า', controller: oldPasswrodController, keyboardType: TextInputType.text, valueSave: '', focus: oldPasswrodFocusNode, hintColor: state.themeApp? Colors.white70 : Colors.black),
                  const SizedBox(height: 10,),
                  Text('รหัสผ่านใหม่', style: TextStyle(fontSize: Responsive.isTablet ? 20 : 18, fontWeight: FontWeight.bold),),
                  systemwidgetcustom.normalTextFormField(hintText: 'รหัสผ่านใหม่', controller: newPasswrodController, keyboardType: TextInputType.text, valueSave: '', focus: newPasswrodFocusNode, hintColor: state.themeApp? Colors.white70 : Colors.black),
                  const SizedBox(height: 10,),
                  Text('ยืนยันรหัสผ่านใหม่', style: TextStyle(fontSize: Responsive.isTablet ? 20 : 18, fontWeight: FontWeight.bold),),
                  systemwidgetcustom.normalTextFormField(hintText: 'ยืนยันรหัสผ่านใหม่', controller: confirmPasswrodController, keyboardType: TextInputType.text, valueSave: '', focus: confirmPasswrodNode, hintColor: state.themeApp? Colors.white70 : Colors.black),
                  const SizedBox(height: 10,),
                  ElevatedButton(onPressed: () {}, style: ElevatedButton.styleFrom(backgroundColor: secColor), child: const Text('บันทึก',style: TextStyle(fontSize: 18,color: Colors.white,fontWeight: FontWeight.bold),),),
                ],
              );
